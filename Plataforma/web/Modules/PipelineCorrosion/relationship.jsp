...
<html>
    ...
    <body>
        ...
        <div class="col-lg-12">
            <div class="col-md-3">
                <input type="button" id="cleanAllBtn_rel" name="cleanAllBtn_rel" value="Clean All Data" onclick="cleanAll_rel()" class="btn btn-warning btn-block"></div>
            <div class="col-md-3">
                <input type="button" id="cleanInputBtn_rel" name="cleanInputBtn_rel" value="Clean Input Data" onclick="cleanIn_rel()" class="btn btn-warning btn-block"></div>
            <div class="col-md-3">
                <input type="button" id="cleanOutputBtn_rel" name="cleanOutputBtn_rel" value="Clean Output Data" onclick="cleanOut_rel()" class="btn btn-warning btn-block"></div>
        </div>
