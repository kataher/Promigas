...
<html>
    ...
    <body>
        ...
        <div class="col-lg-12">
            <div class="col-md-3">
                <input type="button" id="cleanAllBtn_elr" name="cleanAllBtn_elr" value="Clean All Data" onclick="cleanAll_elr()" class="btn btn-warning btn-block"></div>
            <div class="col-md-3">
                <input type="button" id="cleanInputBtn_elr" name="cleanInputBtn_elr" value="Clean Input Data" onclick="cleanIn_elr()" class="btn btn-warning btn-block"></div>
            <div class="col-md-3">
                <input type="button" id="cleanOutputBtn_elr" name="cleanOutputBtn_elr" value="Clean Output Data" onclick="cleanOut_elr()" class="btn btn-warning btn-block"></div>
        </div>
