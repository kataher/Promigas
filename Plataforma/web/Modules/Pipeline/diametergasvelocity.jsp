...
<html>
 ...
 <input type="button" id="delteBtn_dgv" name="delteBtn_dgv" value="Delete" onclick="delete_dgv()" class="btn btn-danger btn-block">
            ...
            <input type="hidden" id="opt_dgv" name="opt_dgv"> 
            <input type="hidden" id="id_dgv" name="id_dgv">   
                    ...
                    $.ajax({
                        ...
                        success: function(data, status, request){
                            if (data != null)
                            {
                                ...
                                $("#proyects_sel_dgv").val(data.row.id_proyect);
                ...
                function calculate_dgv(){
                 ...
                 function save_dgv(){
                        ...
                        var parametros = {
                                    ...
                                    "bt_sel_dgv": $("#bt_sel_dgv").val(),
                                    "bp_sel_dgv" : $("#bp_sel_dgv").val(),
                                    "fp_sel_dgv" : $("#fp_sel_dgv").val(),
                                    "ft_sel_dgv" : $("#ft_sel_dgv").val(),
                                    "pid_sel_dgv": $("#pid_sel_dgv").val(),
                                    "fr_sel_dgv": $("#fr_sel_dgv").val(),
                                    "gs_sel_dgv": $("#gs_sel_dgv").val(),
                                    "al_sel_dgv": $("#al_sel_dgv").val(),
                                    
                                    "gasv_dgv": $("#gasv_dgv").val(),
                                    "z_dgv": $("#z_dgv").val(),

                                    "idproyect": $("#proyects_sel_dgv").val(),
                                    "opcion": $("#opt_dgv").val(),
                                    "iduser": <% out.print(session.getAttribute("idusu"));%>,
                                    "id_dgv": 1,
                                    "description_dgv": $("#description_dgv").val(),
                                    "from": "dgv"
                            };
