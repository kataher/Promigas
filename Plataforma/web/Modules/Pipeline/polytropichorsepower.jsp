...
<html>
 ...
 <input type="button" id="delteBtn_php" name="delteBtn_php" value="Delete" onclick="delete_php()" class="btn btn-danger btn-block">
            ...
            <input type="hidden" id="opt_php" name="opt_php"> 
            <input type="hidden" id="id_php" name="id_php">   
                ...
                function save_php(){
                    var sel = $("input[type='radio'][name='opz_php']:checked");
                        ...
                        var parametros = {
                                    ...
                                    "adiabatice_php" : $("#adiabatice_php").val(),
                                    "gs_sel_php" :  $("#gs_sel_php").val(),
                                    "gst_php": $("#gst_php").val(),
                                    "mechanicale_php": $("#mechanicale_php").val(),
                                    "polytropice_php": $("#polytropice_php").val(),
            
                                    "discharget_php": $("#discharget_php").val(),
                                    "polytropicex_php": $("#polytropicex_php").val(),
                                    "zavg_php": $("#zavg_php").val(),
                                    "adiabatich_php": $("#adiabatich_php").val(),
                                    "adiabaticghp_php": $("#adiabaticghp_php").val(),
                                    "ghp_php": $("#ghp_php").val(),
                                    "bhp_php": $("#bhp_php").val(),
                                    "acfm_php": $("#acfm_php").val(),

                                    "bt_sel_php": $("#bt_sel_php").val(),
                                    "bp_sel_php": $("#bp_sel_php").val(),
                                    "sp_sel_php": $("#sp_sel_php").val(),
                                    "st_sel_php": $("#st_sel_php").val(),
                                    "dp_sel_php": $("#dp_sel_php").val(),
                                    "cr_sel_php": $("#cr_sel_php").val(),
                                    
                                    "idproyect": $("#proyects_sel_php").val(),
                                    "opcion": $("#opt_php").val(),
                                    "iduser": <% out.print(session.getAttribute("idusu"));%>,
                                    "id_php": 1,
                                    "description_php": $("#description_php").val(),
                                    "from": "php"
                            };
