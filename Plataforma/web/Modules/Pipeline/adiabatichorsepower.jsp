...
<html>
    ...
    <body>
        <div class="row">
            <div class="col-lg-9">
                <h2><strong>Pipe Installation:</strong> 1.1.2. entrifugal Compressor-Required Adiabatic Horsepower</h2>
            </div>
             <div class="col-lg-3"> 
 ...
 <input type="button" id="delteBtn_ahp" name="delteBtn_ahp" value="Delete" onclick="delete_ahp()" class="btn btn-danger btn-block">
            ...
            <input type="hidden" id="opt_ahp" name="opt_ahp"> 
            <input type="hidden" id="id_ahp" name="id_ahp">   
                        ...
                        success: function(data, status, request){
                            ...
                            if (data !== null)
                            {
                                ...
                                for(var i = 0; i < tags.length; i++){
                                    if(tags[i] !== "date" && tags[i] !== "id_proyect" && tags[i] !== "id_user" && tags[i]!== "id" &&  tags[i]!=="opz_ahp")
                                    {
                                ...
                                $("#proyects_sel_ahp").val(data.row.id_proyect);
                            }else{
                                $("#opt_ahp").val("1");
                            }
                        },
                ...
                function save_ahp(){
                    var sel = $("input[type='radio'][name='opz_ahp']:checked");
                        ...
                        var parametros = {
                                    ...
                                    "z1s_ahp": $("#z1s_ahp").val(),
                                    "z2d_ahp": $("#z2d_ahp").val(),
                                    "basepressure_ahp": $("#basepressure_ahp").val(),
                                    "basetemperature_ahp": $("#basetemperature_ahp").val(),
                                    "suctionp_ahp" : $("#suctionp_ahp").val(),
                                    "suctiont_ahp": $("#suctiont_ahp").val(),
                                    "dischargep_ahp" : $("#dischargep_ahp").val(),
                                    "capacityr_ahp" : $("#capacityr_ahp").val(),
                                    "gass_ahp" : $("#gass_ahp").val(),
                                    "enteree_ahp" : $("#enteree_ahp").val(),
                                    
                                    
                                    "adiabatice_ahp" : $("#adiabatice_ahp").val(),
                                    "gs_sel_ahp" :  $("#gs_sel_ahp").val(),
                                    "gst_ahp": $("#gst_ahp").val(),
                                    "mechanicale_ahp": $("#mechanicale_ahp").val(),
                                  
                                    "discharget_ahp": $("#discharget_ahp").val(),
                                    "zavg_ahp": $("#zavg_ahp").val(),
                                    "adiabatich_ahp": $("#adiabatich_ahp").val(),
                                    "adiabaticghp_ahp": $("#adiabaticghp_ahp").val(),
                                    "ghp_ahp": $("#ghp_ahp").val(),
                                    "bhp_ahp": $("#bhp_ahp").val(),
                                    "acfm_ahp": $("#acfm_ahp").val(),

                                    "bt_sel_ahp": $("#bt_sel_ahp").val(),
                                    "bp_sel_ahp": $("#bp_sel_ahp").val(),
                                    "sp_sel_ahp": $("#sp_sel_ahp").val(),
                                    "st_sel_ahp": $("#st_sel_ahp").val(),
                                    "dp_sel_ahp": $("#dp_sel_ahp").val(),
                                    "cr_sel_ahp": $("#cr_sel_ahp").val(),
                                    ...
                                    "iduser": <% out.print(session.getAttribute("idusu"));%>,
                                    "id_ahp": 1,
                                    "description_ahp": $("#description_ahp").val(),
                                    "from": "ahp"
                            };
