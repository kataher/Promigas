        ...
        <script>
                ...
                function load_datasheet_sh(){
                    ...
                    if ($("#material_sh").val().split(",")[1] === "psig") {
                        pres = Number($("#material_sh").val());
                    }else{
                        pres = Number($("#material_sh").val()) * 14.504;
                    }
                ...
                function setGrafica_sh(){
                    ...
                    var evemin= 0; var evemax= 0; var evepo= 0;
                    ...
                    Morris.Line({
                            element: 'graficaLineal_sh',
                            data: data,
                            xkey: 'x',
                            ykeys: ['a'],
                            labels: ['Capacidad de Slam Shut'],
                            events: [
                              evemin,
                              evemax,
                              evepo
                ...
                function deleteconfirm_sh(){
                    ...
                    $.ajax({
                        ...
                        success: function(data, status, request){
                            ...
                            $("#id_sh").val("");
                            $("#opt_sh").val("1");
                            show_OkDialog($("#delete_Dialog_sh"), "Satisfactory process");
                        },
                        error: function (xhr, ajaxOptions, err) {
                            alert(err);
                            show_OkDialog($("#error_Dialog_sh"), "Error");
