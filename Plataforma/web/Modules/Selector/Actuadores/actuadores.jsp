    ...
    <body>
        ...
        <script>
            ...
            function setGrafica_act() {
                ...
                var te = parseFloat($("#torquees_act").val().replace(",",""));
                var tmr = parseFloat($("#torquema_act").val().replace(",",""));

                var data = [];
                var eve = Number($("#pre_sel_act").val().split(",")[1]);
                var j = 0;
                
                var aux = parseFloat($("#toes_sel_act").val().split(",")[1]);
                var maxR = Math.max(te, tmr)*aux*1.13;
                ...
                var layout = {
                    ...
                    yaxis: {
                        title: 'Actuator Torque [Lb-in]'
                    }
                };
                
                Plotly.newPlot('graficaLineal_act', data, layout);
