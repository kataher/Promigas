        ...
        <script>
                ...
                function load_datasheet_meu(){
                    ...
                    if ($("#po_sel_meu").val().split(",")[1] === "psig") {
                        pres = Number($("#presionop_meu").val());
                    }else{
                        pres = Number($("#presionop_meu").val()) * 14.504;
                    }
                ...
                function setGrafica_meu(){
                    ...
                    for(var i = 0; i <= fin; i = i + 1){
                        ...
                        enope[j] = parseFloat($("#flujomax_meu").val());
