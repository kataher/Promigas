...
<link rel="stylesheet" href="https://cdn.datatables.net/buttons/1.2.4/css/buttons.dataTables.min.css">
    ...
    <body>
        ...
        <hr>
            ...
            <div class="col-md-8">
            <input value="80"  class="form-control" type="text" id="presionop_mem" name="presionop_mem" onchange="onchange_Input_mem(this)" required>
            </div>
            ...
            <div class="col-md-8">
            <input  class="form-control" type="text" id="preisonba_mem" name="preisonba_mem" value="14.7" onchange="onchange_Input_mem(this)" required><br>
            </div>
            ...
            <label>Minimum Flow of Operation:</label>
                ...
                <div class="col-md-8">
                <input value="37.5" class="form-control" type="text" id="flujomin_mem" name="flujomin_mem" onchange="onchange_Input_mem(this)" required>
                 </div>
            ...
            <label>Maximum Flow of Operation:</label>
                ...
                <div class="col-md-8">
                <input value="400" class="form-control" type="text" id="flujomax_mem" name="flujomax_mem" onchange="onchange_Input_mem(this)" required>
                 </div>
 ...
 <input type="button" id="datasheetgen_mem" name="datasheetgen_mem" value="Generate DataSheet" onclick="load_datasheet_mem()" class="btn btn-success btn-block">   
        ...
        <script>
                ...
                function setGrafica_mem(){
                    ...
                    var caprefop = parseFloat($("#capaopt_mem").val());
                    var caprefev  = parseFloat($("#mo_sel_mem").val().split(",")[1]);
                    
                    var presb = parseFloat($("#preisonba_mem").val());
                    //var aux = ($("#pb_sel_mem").val().split(",")[1] == "psig" ? 1 : 14.504); //1 si es psi, 14.504 si es bar 
                    var evaluado = [];
                    var enope = [];
                    var optimo = [];
                    var data = [];
                    var eve = Number($("#presionop_mem").val());
                    ...
                    for(var i = 0; i <= fin; i = i + 1){
                        evaluado[j] = (i+presb)/(presb)*caprefev;
                        optimo[j] = (i+presb)/(presb)*caprefop;
                        enope[j] = parseFloat($("#flujomax_mem").val());
                        
                        data[j] = { x: i.toString(), c:enope[j].toFixed(0) };
