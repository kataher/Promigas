                                                        ...
                                                        <div class="panel-body">
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label id="lblPC_phy">Pressure change  [Psi/°F]: </label>            
    ...
    <script>
        ...
        function load_temp_sel_phy() {
            ...
            $.ajax({
                ...
                success: function (data, status, request) {
                    var newHtml = "<select class='form-control' name='tt_sel_phy' id= 'tt_sel_phy' onchange='onchange_ttemp(this)'>" + data;
        ...
        function onchange_ttemp() {
            var value = $("#tt_sel_phy").val().split(",")[1];
            $("#lblPC_phy").html("Pressure change [Psi/°" + value + "]:");
