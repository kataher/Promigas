...
<html>
    ...
    <body>
        <div class="row">
            <div class="col-lg-9">
                <h2><strong>Surcharge Live Load on Buried PE Pipe & Pipeline Crossings: </strong> Carga Uniforme Aplicada Sobre Tuberia de Pilietileno</h2>
            </div>
            <div class="col-lg-3">
        ...
        <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                 ...
                                 <input type="radio" id = "over_dst" name="met_dst" value="1" required onchange="onchangeimg_dst(this)"> Carga directamente <br>
                                 <input type="radio" id = "notover_dst" name="met_dst" value="2" required onchange="onchangeimg_dst(this)"> Carga no directamente
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                      ...
                                      <div class="checkbox">                               
                                            <input type="radio" id = "hdpe_dst" name="melas_dst" value="hdpe_dst" required onchange="onchangeae_dst(this)"> Alta densidad del polietileno
                                            <input type="radio" id = "mdpe_dst" name="melas_dst" value="mdpe_dst" required onchange="onchangeae_dst(this)"> Media densidad del polietileno<br>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                <div class="col-md-12">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">                                   
                                    <div class="form-group">
                 <div class="col-md-12">
            <label>Peso unitario del suelo [lb/ft3]:</label>
                 </div>
            <div class="col-md-8">
            <input class="form-control" value= "112" type="text" id="unitw_dst" name="unitw_dst" onchange="onchange_Input_dst(this)" required>
            </div>
            </div>
            <div class="form-group">
                 <div class="col-md-12">
            <label>Profundidad de la tubería:</label>
                 </div>
            <div class="col-md-8">
            <input  class="form-control" value="3" type="text" id="hight_dst" name="hight_dst" onchange="onchange_Input_dst(this)" required><br>
            </div>
            ...
            <div class="form-group">
                <div class="col-md-12">
                <label>Bd -Ancho de la zanga en la corona [ft]:</label>
                </div>
            <div class="col-md-8">
            <input class="form-control" type="text" value="2" id="bd_dst" name="bd_dst" onchange="validate_pres_dst(this)" required>
            </div>
            ...
            <label>For Soil:</label>
                ...
                <input  class="form-control" type="text" id="ku_dst" name="ku_dst" onchange="onchange_Input_dst(this)" required>
                                    ...
                                    <div class="form-group">
                <div class="col-md-12">
                <label>E' Modulo de reacción del suelo [psi]:</label>
                </div>
            <div class="col-md-12">
            <input class="form-control" value="5" type="text" id="ep_dst" name="ep_dst" onchange="validate_pres_dst(this)" required>
            </div>
             </div>
                                   
                                    <div class="form-group">
                <div class="col-md-12">
                <label>E'n -Módulo de reacción del suelo nativo [psi]:</label>
                </div>
            <div class="col-md-12">
            <input class="form-control" value="8" type="text" id="en_dst" name="en_dst" onchange="validate_pres_dst(this)" required>
            </div>
             </div>
                                   
                                    <div class="form-group">
                <div class="col-md-12">
                <label>Factor de deflección (Typically 1.0 - 1.5):</label>
                </div>
            <div class="col-md-12">
            <input class="form-control" value="1.2" type="text" id="ldl_dst" name="ldl_dst" onchange="validate_pres_dst(this)" required>
            </div>
             </div>
                                   
                                    <div class="form-group">
                <div class="col-md-12">
                <label>Factor de fondo (Tipicamente 0.1):</label>
                </div>
            <div class="col-md-12">
            <input class="form-control" value="0.1" type="text" id="kb_dst" name="kb_dst" onchange="validate_pres_dst(this)" required>
            </div>
             </div>
                                    </div>
                            </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">                                   
                                    <div class="form-group">
                 <div class="col-md-12">
            <label>Do - Diametro exterior de la tubería [in]:</label>
                 </div>
            <div class="col-md-8">
            <input class="form-control" value="4.5" type="text" id="do_dst" name="do_dst" onchange="onchange_Input_dst(this)" required>
            </div>
            ...
            <select class="form-control" id="do_sel_dst" name="do_sel_dst" onchange="cleanOut_dst()"> </select>
                                    ...
                                    <div class="form-group">
                <div class="col-md-12">
                <label>Relacion diametro espesos DR o SDR:</label>
                </div>
            <div class="col-md-12">
            <input class="form-control" value="32.5" type="text" id="dr_dst" name="dr_dst" onchange="validate_pres_dst(this)" required>
            </div>            
             </div>
                                    <div class="form-group">
                <div class="col-md-12">
                <label>Modulo de elasticidad de la tubería [psi]:</label>
                </div>
            <div class="col-md-12">
            <input class="form-control" value="110000" type="text" id="e_dst" name="e_dst" onchange="validate_pres_dst(this)" required>
            </div>            
             </div>
                                    <div class="form-group">
                <div class="col-md-12">
            ...
            <input class="form-control" type="text" id="as_dst" name="as_dst" onchange="validate_pres_dst(this)" required>
                 ...
                 <div class="col-md-12">
            <label>Presión de carga distribuida [lb/ft2]:</label>
                 </div>
            <div class="col-md-12">
            <input class="form-control" value="500" type="text" id="ds_dst" name="ds_dst" onchange="onchange_Input_dst(this)" required>
            </div>
            </div>
                                    <div class="form-group">
                <div class="col-md-12">
            ...
            <div class="col-md-8">
            <input class="form-control" value="1" type="text" id="n_dst" name="n_dst" onchange="validate_pres_dst(this)" required>
            </div>
            ...
            <div class="col-md-8">
            <input class="form-control"  value="1.2" type="text" id="m_dst" name="m_dst" onchange="validate_pres_dst(this)" required>
            </div>
            ...
            <div class="col-md-8">
            <input class="form-control"  value="1.5" type="text" id="m1_dst" name="m1_dst" onchange="validate_pres_dst(this)" required>
            </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
             <div class="form-group">
            <label> Vertical soil pressure [lb/ft2]:</label>
