...
<label>Safe Long-Term Deflection Desing values for Buried Pressurized Polyethylene Pipe</label>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <input type="button" id="calculate_poi" name="calculate_poi" value="Calculate" onclick="calculate_poi()" class="btn btn-info btn-block">
                            <input type="button" id="save_poi" name="save_poi" value="Save" onclick="save_poi()" class="btn btn-success btn-block">  
                            <input type="button" id="delete_poi" name="delete_poi" value="Delete" onclick="delete_poi()" class="btn btn-danger btn-block">
        ...
        <input type="hidden" id="opt_poi" name="opt_poi">
