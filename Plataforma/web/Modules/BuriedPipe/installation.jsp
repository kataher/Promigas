    ...
    <body>
        ...
        <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <input type="button" id="calculateBtcro_ins" name="calculateBtcro_ins" value="Calculate" onclick="calculate_ins()" class="btn btn-info btn-block">
                                    <input type="button" id="saveBtcro_ins" name="saveBtcro_ins" value="Save" onclick="save_ins()" class="btn btn-success btn-block">  
                                    <input type="button" id="delteBtcro_ins" name="delteBtcro_ins" value="Delete" onclick="delete_ins()" class="btn btn-danger btn-block">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-3">
                    <input type="button" id="cleanAllBtcro_ins" name="cleanBtcro_ins" value="Clean All Data" onclick="cleanAll_ins()" class="btn btn-warning btn-block">
                </div>
                <div class="col-md-3">
                    <input type="button" id="cleanInputBtcro_ins" name="cleanBtcro_ins" value="Clean Input Data" onclick="cleanIn_ins()" class="btn btn-warning btn-block">
                </div>
                <div class="col-md-3">
                    <input type="button" id="cleanOutputBtcro_ins" name="cleanBtcro_ins" value="Clean Output Data" onclick="cleanOut_ins()" class="btn btn-warning btn-block">
                </div>
            </div>

        </div>
        <input type="hidden" id="id_ins" name="id_ins"> 
        <input type="hidden" id="opt_ins" name="opt_ins">
