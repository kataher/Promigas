...
<html>
                                        ...
                                        <select class="form-control" id="ee_sel_mll" name="ee_sel_mll"> </select>
                                          ...
                                          <div class="col-md-12">
                                           ...
                                           <div class="col-md-12 form-group success"  id="internal">
                                            ...
                                            <input class="form-control" type="text" id="internalpipe_mll" name="internalpipe_mll"  required>
                                           </div>
                                            </div>
                                            <div class="col-md-12">
 ...
 <input type="button" id="delteBtn" name="delteBtn" value="Eliminar" onclick="deleteReg_mll()" class="btn btn-danger btn-block">
