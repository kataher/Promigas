...
<html>
    ...
    <body>
                                ...
                                <div class="col-lg-12">
                                    <form role="form">
                                      ...
                                      <select class="form-control" id="roughness_aga" name="roughness_aga"> </select>
                                          ...
                                          <div  class="col-md-12">
                                           <div class="col-md-12 success"  id="internal">
        ...
        <div class="col-lg-3">
            ...
            <input type="button" id="delteBtn" name="delteBtn" value="Eliminar" onclick="deleteReg_aga()"  class="btn btn-danger btn-block">
