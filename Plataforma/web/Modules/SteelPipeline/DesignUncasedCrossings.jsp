                ...
                <div class="row">
                    <div id="content">
                        ...
                        <div class="row">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading"> Impact Factor </div>
                                                        <div class="panel-body">
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <form role="form">
                                                ...
                                                <div class="form-group">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading"> Operational Pipe Data </div>
                                                        <div class="panel-body">
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <form role="form">
                            ...
                            <input type="hidden" id="opt_duc" name="opt_duc"> 
                            <input type="hidden" id="id_duc" name="id_duc"> 
                        </div>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <input type="button" id="cleanAllBtn_duc" name="cleanBtn_duc" value="Clean All" onclick="cleanAll_duc()" class="btn btn-warning btn-block">
                                            <input type="button" id="cleanInputBtn_duc" name="cleanBtn_duc" value="Clean Input Data" onclick="cleanIn_duc()" class="btn btn-warning btn-block">
                                            <input type="button" id="cleanOutputBtn_duc" name="cleanBtn_duc" value="Clean Output Data" onclick="cleanOut_duc()" class="btn btn-warning btn-block">
                        ...
                        <div id="load_Dialog_duc" title="Basic dialog" style='display:none;'>
                            <p>Successfully uploaded data</p>
                        </div>

                        <div id="save_Dialog_duc" title="Basic dialog" style='display:none;'>
                            <p>Data saved successfully</p>
                        </div>

                        <div id="error_Dialog_duc" title="Basic dialog" style='display:none;'>
                            <p>An error has occurred in the process</p>
                        </div>

                        <div id="calculate_Dialog_duc" title="Basic dialog" style='display:none;'>
                            <p>Calculation done successfully</p>
                        </div>

                        <div id="delete_Dialog_duc" title="Basic dialog" style='display:none;'>
                            <p>Successfully deleted record</p>
                        </div>

                        <div id="dialog-confirm_duc" title="Delete record" style='display:none;'>
