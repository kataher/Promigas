...
<html lang="en">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div id="Lpipe">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control" id="youngModulusForSteel1_spcr" onchange='onchange_Input_spcr(this)' required> 
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <select class="form-control" id="youngModulusForSteel1_sel_spcr">
                                                        ...
                                                        <form role="form">
                                                            <div class="form-group">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="text" class="form-control" id="operatingPressure_spcr" onchange='onchange_Input_spcr(this)' required> 
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <select class="form-control" id="operatingPressure_sel_spcr">
                                                                            <option value="psi">psi</option>
                                                                            <option value="MPa">MPa</option>
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="text" class="form-control" id="operatingTemperature_spcr" value="60" onchange='onchange_Input_spcr(this)' required> 
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <select class="form-control" id="operatingTemperature_sel_spcr">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="text" class="form-control" id="pipeOutsideDiameter_spcr" onchange='onchange_Input_spcr(this)' required> 
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <select class="form-control" id="pipeOutsideDiameter_sel_spcr">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="text" class="form-control" id="pipeWallThickness_spcr" onchange='onchange_Input_spcr(this)' required> 
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <select class="form-control" id="pipeWallThickness_sel_spcr">
                                                                            <option value="in">in</option>
                                                                            <option value="cm">cm</option>
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <input type="text" class="form-control" id="pipeGrade_spcr" onchange='onchange_Input_spcr(this)' required> 
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <input type="text" class="form-control" id="specificiedMinimunYieldStress_spcr" onchange='onchange_Input_spcr(this)' required> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
                                                        ...
                                                        <form role="form">
                                                            <div class="form-group">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="text" class="form-control" id="pipeDepth_spcr" onchange='onchange_Input_spcr(this)' required> 
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <select class="form-control" id="pipeDepth_sel_spcr">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="text" class="form-control" id="boredDiameter_spcr" onchange='onchange_Input_spcr(this)' required> 
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <select class="form-control" id="boredDiameter_sel_spcr">
                                                                            <option value="in">in</option>
                                                                            <option value="cm">cm</option>
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="text" class="form-control" id="installationTemperature_spcr" onchange='onchange_Input_spcr(this)' required> 
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <select class="form-control" id="installationTemperature_sel_spcr">
                                                                            <option value="F">F</option>
                                                                            <option value="C">C</option>
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="text" class="form-control" id="distanceOfGirthWeldFromTrackCenterline_spcr" onchange='onchange_Input_spcr(this)' required> 
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <select class="form-control" id="distanceOfGirthWeldFromTrackCenterline_sel_spcr">
                                                                            <option value="ft">ft</option>
                                                                            <option value="mt">m</option>
                                                                        </select>
                                                                    </div>
    ...
    <script>
        ...
        function calculatebtn_spcr1() {
            ...
            var unidades = {
                "youngModulusForSteel1_sel_spcr": $("#youngModulusForSteel1_sel_spcr").val(),
              "operatingPressure_sel_spcr": $("#operatingPressure_sel_spcr").val(),
              "operatingTemperature_sel_spcr": $("#operatingTemperature_sel_spcr").val(),
              "pipeOutsideDiameter_sel_spcr": $("#pipeOutsideDiameter_sel_spcr").val(),
              "pipeWallThickness_sel_spcr": $("#pipeWallThickness_sel_spcr").val(),
              "pipeDepth_sel_spcr": $("#pipeDepth_sel_spcr").val(),
              "boredDiameter_sel_spcr": $("#boredDiameter_sel_spcr").val(),
              "installationTemperature_sel_spcr": $("#installationTemperature_sel_spcr").val(),
              "distanceOfGirthWeldFromTrackCenterline_sel_spcr": $("#distanceOfGirthWeldFromTrackCenterline_sel_spcr").val()
            };
            ...
            var res = SteelpipelinesCR(parameter, unidades);
