...
<html>
    ...
    <body>
        ...
        <div class="col-lg-12">
            <div class="col-md-3">
                <input type="button" id="cleanAllBtn_rmva" name="cleanAllBtn_rmva" value="Clean All Data" onclick="cleanAll_rmva()" class="btn btn-warning btn-block"></div>
            <div class="col-md-3">
                <input type="button" id="cleanInputBtn_rmva" name="cleanInputBtn_rmva" value="Clean Input Data" onclick="cleanIn_rmva()" class="btn btn-warning btn-block"></div>
            <div class="col-md-3">
                <input type="button" id="cleanOutputBtn_rmva" name="cleanOutputBtn_rmva" value="Clean Output Data" onclick="cleanOut_rmva()" class="btn btn-warning btn-block"></div>
        </div>
