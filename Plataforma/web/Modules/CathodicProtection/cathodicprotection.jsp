                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="button" id="cleanAllBtn_cc" name="cleanBtn_cc" value="Clean All Data" onclick="cleanAll_cc()" class="btn btn-warning btn-block">
                                                <input type="button" id="cleanInputBtn_cc" name="cleanBtn_cc" value="Clean Input Data" onclick="cleanIn_cc()" class="btn btn-warning btn-block">
                                                <input type="button" id="cleanOutputBtn_cc" name="cleanBtn_cc" value="Clean Output Data" onclick="cleanOut_cc()" class="btn btn-warning btn-block">
                                            </div>
                                        </div>
                                    </div>
                                </div>
