...
<html>
    ...
    <body>
        ...
        <div class="col-lg-12">
            <div class="col-md-3">
                <input type="button" id="cleanAllBtn_rsha" name="cleanAllBtn_rsha" value="Clean All Data" onclick="cleanAll_rsha()" class="btn btn-warning btn-block"></div>
            <div class="col-md-3">
                <input type="button" id="cleanInputBtn_rsha" name="cleanInputBtn_rsha" value="Clean Input Data" onclick="cleanIn_rsha()" class="btn btn-warning btn-block"></div>
            <div class="col-md-3">
                <input type="button" id="cleanOutputBtn_rsha" name="cleanOutputBtn_rsha" value="Clean Output Data" onclick="cleanOut_rsha()" class="btn btn-warning btn-block"></div>
        </div>
