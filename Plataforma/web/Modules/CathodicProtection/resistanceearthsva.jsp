...
<html>
    ...
    <body>
        ...
        <div class="col-lg-12">
            <div class="col-md-3">
                <input type="button" id="cleanAllBtn_rsva" name="cleanAllBtn_rsva" value="Clean All Data" onclick="cleanAll_rsva()" class="btn btn-warning btn-block"></div>
            <div class="col-md-3">
                <input type="button" id="cleanInputBtn_rsva" name="cleanInputBtn_rsva" value="Clean Input Data" onclick="cleanIn_rsva()" class="btn btn-warning btn-block"></div>
            <div class="col-md-3">
                <input type="button" id="cleanOutputBtn_rsva" name="cleanOutputBtn_rsva" value="Clean Output Data" onclick="cleanOut_rsva()" class="btn btn-warning btn-block"></div>
        </div>
