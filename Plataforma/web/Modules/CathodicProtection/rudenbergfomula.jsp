                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="button" id="cleanAllBtn_rf" name="cleanBtn_rf" value="Clean All Data" onclick="cleanAll_rf()" class="btn btn-warning btn-block">
                                                <input type="button" id="cleanInputBtn_rf" name="cleanBtn_rf" value="Clean Input Data" onclick="cleanIn_rf()" class="btn btn-warning btn-block">
                                                <input type="button" id="cleanOutputBtn_rf" name="cleanBtn_rf" value="Clean Output Data" onclick="cleanOut_rf()" class="btn btn-warning btn-block">
                                            </div>
                                        </div>
                                    </div>
                                </div>
