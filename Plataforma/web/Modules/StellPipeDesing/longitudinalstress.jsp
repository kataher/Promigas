  ...
  <body>
    ...
    <hr>
     ...
     <div class="tab-content">
      ...
      <div class="col-lg-12">
        <div class="col-md-3">
          <input type="button" id="cleanAllBtn_ls" name="cleanBtn_ls" value="Clean All" onclick="cleanAll_ls()" class="btn btn-warning btn-block">
        </div>
        <div class="col-md-3">
          <input type="button" id="cleanInputBtn_ls" name="cleanBtn_ls" value="Clean Input Data" onclick="cleanIn_ls()" class="btn btn-warning btn-block">
        </div>
        <div class="col-md-3">
          <input type="button" id="cleanOutputBtn_ls" name="cleanBtn_ls" value="Clean Output Data" onclick="cleanOut_ls()" class="btn btn-warning btn-block">
        </div>    
      </div>
      ...
      <input type="hidden" id="id_ls" name="id_ls">   
           <script>
                ...
                function cleanOut_lostre(){
                    ...
                    $("#thermalc_lostre").val("");
                    $("#volumecr_lostre").val("");
                    $("#pipelinef_lostre").val("");
                    $("#volumer_lostre").val("");
                    $("#incrementalv_lostre").val("");
                    $("#compf_lostre").val("");
                    $("#pressurec_lostre").val("");
                }
