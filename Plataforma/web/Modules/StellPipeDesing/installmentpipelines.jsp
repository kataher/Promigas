                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-lg-5">
                        <input type="text" name="peso_tub_aire_inpp" id="peso_tub_aire_inpp" class="form-control">
                      </div>                       
                      <div class="col-lg-7">
                        <label>Volúmen Exterior de la Tubería [ft3/ft]:</label>
                       </div> 
                      <div class="col-lg-5">
                        <input type="text" name="vol_ext_tub_inpp" id="vol_ext_tub_inpp" class="form-control">
                      </div>  
                      <div class="col-lg-7">
                        <label>Volúmen Interior de la Tubería [ft3/ft]::</label>
                      </div> 
                      <div class="col-lg-5">
                        <input type="text" name="vol_int_tub_inpp" id="vol_int_tub_inpp" class="form-control">
                      </div> 
                      <div class="col-lg-7">
                        <label>Peso del Lodo Desplazado [lbs/ft]:</label>
                      </div> 
                      <div class="col-lg-5">
                        <input type="text" name="pes_lob_des_inpp" id="pes_lob_des_inpp" class="form-control">
                      </div> 
                      <div class="col-lg-7">
                        <label>Peso Efectivo de la Tubería [lbs/ft]:</label>
                      </div> 
                      <div class="col-lg-5">
                        <input type="text" name="pes_efe_tub_inpp" id="pes_efe_tub_inpp" class="form-control">
                      </div>                             
                    </div> 
                  </div>
                </div>
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-lg-5">
                          <input type="text" name="fri_suelAB_inpp" id="fri_suelAB_inpp" class="form-control"> 
                      </div>                       
                      <div class="col-lg-7">
                        <label>Fuerza de arrastre del lodo[lbs]:</label>
                       </div> 
                      <div class="col-lg-5">
                        <input type="text" name="fue_arr_lodAB_inpp" id="fue_arr_lodAB_inpp" class="form-control">
                      </div>                            
                      <div class="col-lg-7">
                        <label>Tensión en la Sección[lbs]:</label>
                       </div> 
                      <div class="col-lg-5">
                        <input type="text" name="ten_secAB_inpp" id="ten_secAB_inpp" class="form-control">
                      </div>
                      <div class="col-lg-7">
                        <label>Carga de Tracción Acumulativa[lbs/ft]:</label>
                       </div> 
                      <div class="col-lg-5">
                        <input type="text" name="car_tra_acuAB_inpp" id="car_tra_acuAB_inpp" class="form-control">
                      </div>                           
                    </div> 
                  </div>
                </div>
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-lg-5">
                        <input type="text" name="fue_nor_inpp" id="fue_nor_inpp" class="form-control">
                      </div>
                       <div class="col-lg-7">
                        <label>Fricción del Suelo[lbs]:</label>
                       </div> 
                      <div class="col-lg-5">
                        <input type="text" name="fri_del_suelBC_inpp" id="fri_del_suelBC_inpp" class="form-control">
                      </div> 
                       <div class="col-lg-7">
                        <label>Fuerza de Arrastre del lodo[lbs]:</label>
                       </div> 
                      <div class="col-lg-5">
                        <input type="text" name="fue_arr_lobBC_inpp" id="fue_arr_lobBC_inpp" class="form-control">
                      </div> 
                       <div class="col-lg-7">
                        <label>Tensión en la Sección[lbs]:</label>
                       </div> 
                      <div class="col-lg-5">
                        <input type="text" name="ten_secBC_inpp" id="ten_secBC_inpp" class="form-control">
                      </div> 
                       <div class="col-lg-7">
                        <label>Carga de Tracción Acumulativa[lbs/ft]:</label>
                       </div> 
                      <div class="col-lg-5">
                        <input type="text" name="car_tra_acuBC_inpp" id="car_tra_acuBC_inpp" class="form-control">
                      </div>                                               
                    </div> 
                  </div>
                </div>
                 ...
                 <div class="col-lg-12">                                    
                  ...
                  <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-lg-5">
                        <input type="text" name="fri_del_sueCD_inpp" id="fri_del_sueCD_inpp" class="form-control">
                      </div>                       
                       <div class="col-lg-7">
                        <label>Fuerza de arrastre del lodo[lbs]:</label>
                       </div> 
                      <div class="col-lg-5">
                        <input type="text" name="fue_arr_lobCD_inpp" id="fue_arr_lobCD_inpp" class="form-control">
                      </div> 
                       <div class="col-lg-7">
                        <label>Tensión en la Sección[lbs]:</label>
                       </div> 
                      <div class="col-lg-5">
                        <input type="text" name="ten_secCD_inpp" id="ten_secCD_inpp" class="form-control">
                      </div> 
                       <div class="col-lg-7">
                        <label>Carga de Tracción Acumulativa [lbs/ft]:</label>
                       </div> 
                      <div class="col-lg-5">
                        <input type="text" name="car_tra_acuCD_inpp" id="car_tra_acuCD_inpp" class="form-control">
                      </div>                    
                    </div> 
                  </div>
                </div>
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-lg-5">
                        <input type="text" name="fue_norDE_inpp" id="fue_norDE_inpp" class="form-control">
                      </div> 
                       <div class="col-lg-7">
                        <label>Fricción del Suelo[lbs]:</label>
                       </div> 
                      <div class="col-lg-5">
                        <input type="text" name="fri_sueDE_inpp" id="fri_sueDE_inpp" class="form-control">
                      </div> 
                       <div class="col-lg-7">
                        <label>Fuerza de Arrastre del lodo[lbs]:</label>
                       </div> 
                      <div class="col-lg-5">
                        <input type="text" name="fue_arr_lodDE_inpp" id="fue_arr_lodDE_inpp" class="form-control">
                      </div> 
                       <div class="col-lg-7">
                        <label>Tensión en la Sección[lbs]:</label>
                       </div> 
                      <div class="col-lg-5">
                        <input type="text" name="ten_secDE_inpp" id="ten_secDE_inpp" class="form-control">
                      </div> 
                       <div class="col-lg-7">
                        <label>Carga de Tracción Acumulativa[lbs/ft]:</label>
                       </div> 
                      <div class="col-lg-5">
                        <input type="text" name="car_tra_acuDE_inpp" id="car_tra_acuDE_inpp" class="form-control">
                      </div>                            
                    </div> 
                  </div>
                </div>
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-lg-5">
                        <input type="text" name="fri_sueEF_inpp" id="fri_sueEF_inpp" class="form-control">
                      </div> 
                       <div class="col-lg-7">
                        <label>Fuerza de arrastre del lodo[lbs]:</label>
                       </div> 
                      <div class="col-lg-5">
                        <input type="text" name="fue_arr_lodEF_inpp" id="fue_arr_lodEF_inpp" class="form-control">
                      </div> 
                       <div class="col-lg-7">
                        <label>Tensión en la Sección[lbs]:</label>
                       </div> 
                      <div class="col-lg-5">
                        <input type="text" name="ten_secEF_inpp" id="ten_secEF_inpp" class="form-control">
                      </div> 
                       <div class="col-lg-7">
                        <label>Carga de Tracción Acumulativa[lbs/ft]:</label>
                       </div> 
                      <div class="col-lg-5">
                        <input type="text" name="car_tra_acuEF_inpp" id="car_tra_acuEF_inpp" class="form-control">
                      </div>                            
                    </div> 
                  </div>
                </div>
                 ...
                 <div class="col-lg-7">
                      ...
                      <div class="col-lg-5">
                        <input type="text" name="car_tra_total_inpp" id="car_tra_total_inpp" class="form-control">
                      </div>   
           ...
           <script>
                ...
                function calculate_inpp(){
                    ...
                    if(isOk === false){
                        ...
                        $("#Bproject1").val(res[28]); $("#Bproject2").val(res[29]);
                        $("#Bproject3").val(res[30]); $("#Bproject4").val(res[31]);
                        $("#Bproject5").val(res[32]); $("#Cproject1").val(res[33]);
                        $("#Cproject2").val(res[34]); $("#Cproject3").val(res[35]);
                        $("#Cproject4").val(res[36]); $("#Cproject5").val(res[37]);
                        $("#Dproject1").val(res[38]); $("#Dproject2").val(res[39]);
                        $("#Dproject3").val(res[40]); $("#Dproject4").val(res[41]);
                        $("#Dproject5").val(res[42]); $("#Eproject1").val(res[43]);
                        $("#Eproject2").val(res[44]); $("#Eproject3").val(res[45]);
                        $("#Eproject4").val(res[46]); $("#Eproject5").val(res[47]);
                        $("#Fproject1").val(res[48]); $("#Fproject2").val(res[49]);
                        $("#Fproject3").val(res[50]); $("#Fproject4").val(res[51]);
                        $("#Fproject5").val(res[52]);
                        
                        $("#Ballow1").val(res[53]);  $("#Callow1").val(res[58]);
                        $("#Ballow2").val(res[54]);  $("#Callow2").val(res[59]);
                        $("#Ballow3").val(res[55]);  $("#Callow3").val(res[60]);
                        $("#Ballow4").val(res[56]);  $("#Callow4").val(res[61]);
                        $("#Ballow5").val(res[57]);  $("#Callow5").val(res[62]);

                        $("#Dallow1").val(res[63]);  $("#Eallow1").val(res[68]);
                        $("#Dallow2").val(res[64]);  $("#Eallow2").val(res[69]);
                        $("#Dallow3").val(res[65]);  $("#Eallow3").val(res[70]);
                        $("#Dallow4").val(res[66]);  $("#Eallow4").val(res[71]);
                        $("#Dallow5").val(res[67]);  $("#Eallow5").val(res[72]);

                        $("#Fallow1").val(res[73]);  $("#Bpass1").val(res[78]);
                        $("#Fallow2").val(res[74]);  $("#Bpass2").val(res[79]);
                        $("#Fallow3").val(res[75]);  $("#Bpass3").val(res[80]);
                        $("#Fallow4").val(res[76]);  $("#Bpass4").val(res[81]);
                        $("#Fallow5").val(res[77]);  $("#Bpass5").val(res[82]);

                        $("#Cpass1").val(res[83]); $("#Dpass1").val(res[88]);
                        $("#Cpass2").val(res[84]); $("#Dpass2").val(res[89]);
                        $("#Cpass3").val(res[85]); $("#Dpass3").val(res[90]);
                        $("#Cpass4").val(res[86]); $("#Dpass4").val(res[91]);
                        $("#Cpass5").val(res[87]); $("#Dpass5").val(res[92]);
                        
                        $("#Epass1").val(res[93]); $("#Fpass1").val(res[98]);
                        $("#Epass2").val(res[94]); $("#Fpass2").val(res[99]);
                        $("#Epass3").val(res[95]); $("#Fpass3").val(res[100]);
                        $("#Epass4").val(res[96]); $("#Fpass4").val(res[101]);
                        $("#Epass5").val(res[97]); $("#Fpass5").val(res[102]);
