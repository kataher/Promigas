...
<html>
  ...
  <body>
    ...
    <hr>
      ...
      <div class="col-lg-12">
        <div class="col-md-3">
          <input type="button" id="cleanAllBtn_rpl" name="cleanBtn_rpl" value="Clean All" onclick="cleanAll_rpl()" class="btn btn-warning btn-block">
        </div>
        <div class="col-md-3">
          <input type="button" id="cleanInputBtn_rpl" name="cleanBtn_rpl" value="Clean Input Data" onclick="cleanIn_rpl()" class="btn btn-warning btn-block">
        </div>
        <div class="col-md-3">
          <input type="button" id="cleanOutputBtn_rpl" name="cleanBtn_rpl" value="Clean Output Data" onclick="cleanOut_rpl()" class="btn btn-warning btn-block">
        </div>    
      </div>
