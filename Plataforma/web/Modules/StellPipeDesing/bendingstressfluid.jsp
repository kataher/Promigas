            ...
            <div class="row">
              <div class="col-lg-12">                                    
                <div class="form-group">      
                  ...
                  <input type="text" name="unit_weight_bdsf" id="unit_weight_bdsf" class="form-control">                  
                  <label>Pipe outside diameter [in.]:</label>
                  <input type="text" name="pipe_dia_bdsf" id="pipe_dia_bdsf" class="form-control">
                  <label>Pipe Inside Diameter [in.]:</label>
                  <input type="text" class="form-control" id="pipe_in_dia_bdsf" name="pipe_in_dia_bdsf">
                  <label>Velocity of Fluid [ft./sec]:</label>
                  <input type="text" name="vel_fluid_bdsf" id="vel_fluid_bdsf" class="form-control">
                  
                  <div class="form-group">
                    <div class="col-md-12">
                    <label>Lenght of Pipe [ft.]:</label>
                    </div>
                    <div class="col-md-8">
                    <input type="text" class="form-control" id="lenght_pipe_bdsf" name="lenght_pipe_bdsf"> 
                    </div>
            ...
            <div class="row">
              <div class="col-lg-12">                                    
                <div class="form-group">        
                  ...
                  <input type="text" name="bend_stress_bdsf" id="bend_stress_bdsf" class="form-control">
                  <BR>                                      
                  <div>    
            ...
            function load_in_sel_bdsf(){
                    ...
                    $.ajax({
                        ...
                        success: function(data, status, request){ 
                            var newHtml = "<select class='form-control' name='lenght_pipe_sel_bdsf' id= 'lenght_pipe_sel_bdsf'>" + data;
            ...
            function onchange_wt_bdsf(){
                ...
                function calculate_bdsf(){
                    var variables = {
                     ...
                     var res = bending_stress_fluid_form(variables); 
