            ...
            <div id="page-wrapper">
                <div class="row">
                    <div id="content">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading"> Pipe and Operational Data </div>
                                                        <div class="panel-body">
                                                            <div class="row">
                                                                <div class="col-lg-12">                                    
                                                                    <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">                                    
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control" id="despress_pipeop_dp" name="despress_pipeop_dp" readonly>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <select class="form-control output-unit-select" data-output-type="pres" data-output-value="despress_pipeop_dp">
                        ...
                        <div id="load_Dialog_dp" title="Basic dialog" style='display:none;'>
                            <p>Successfully uploaded data</p>
                        </div>

                        <div id="save_Dialog_dp" title="Basic dialog" style='display:none;'>
                            <p>Data saved successfully</p>
                        </div>

                        <div id="error_Dialog_dp" title="Basic dialog" style='display:none;'>
                            <p>An error has occurred in the process</p>
                        </div>

                        <div id="calculate_Dialog_dp" title="Basic dialog" style='display:none;'>
                            <p>Calculation done successfully</p>
                        </div>

                        <div id="delete_Dialog_dp" title="Basic dialog" style='display:none;'>
                            <p>Successfully deleted record</p>
                        </div>

                        <div id="dialog-confirm_dp" title="Delete record" style='display:none;'>
