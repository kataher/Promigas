...
import Model.Hydraulics.WeymouthModel;
 ...
 * @author kata__000
 */
public class WeymouthController extends Controller.Controller {

    private final WeymouthModel model = new WeymouthModel();

    public WeymouthModel getModel() {
        return model;
    }
