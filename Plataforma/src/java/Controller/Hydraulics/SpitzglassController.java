...
import Model.Hydraulics.SpitzglassModel;
 ...
 * @author kata__000
 */
public class SpitzglassController extends Controller.Controller {

    private final SpitzglassModel model = new SpitzglassModel();

    public SpitzglassModel getModel() {
        return model;
    }
